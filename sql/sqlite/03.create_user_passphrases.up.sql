...
CREATE INDEX ra_user_passphrases_inserted_at ON ra_user_passphrases(inserted_at);

CREATE TABLE ra_user_passphrase_invalidations (
...
CREATE INDEX ra_user_passphrase_invalidations_source_user_id ON ra_user_passphrase_invalidations(source_user_id);
