...
CREATE TABLE IF NOT EXISTS ra_files (
    ...
    parent_id bigint null, /* If file is distributed required */
    job_id bigint null,
    ...
    CONSTRAINT fk_ra_files_job_id FOREIGN KEY (job_id)
        REFERENCES ra_jobs(id) ON UPDATE CASCADE ON DELETE cascade
);
